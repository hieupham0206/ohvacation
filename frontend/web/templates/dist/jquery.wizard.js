	...
	methods = {
		init: function (element, options) {
			...
			if(opts.bottomButtons && !bottomActions.length){
				...
				html += '<div class="right-actions" ><span class="'+ opts.btnClass +' '+ opts.btnClassDefault +' btn-next" style="display:none"><span class="next-text">'+ opts.text.next +'</span><span class="finished-text">'+ opts.text.finished +'</span></span></div>';
				html += '<div class="right-actions"><span class="'+ opts.btnClass +' '+ opts.btnClassDefault +' btn-next-otp"><span class="next-text-otp">'+ opts.text.next +'</span></span></div>';
				html += '</div>';
				
				// that.$element.find('.steps-content').append(html); 
				that.$element.find('.steps-footer').append(html);
			}
			...
			this.$element.find('.btn-next-otp').append('<i class="wiz-icon-arrow-right"></i>');
